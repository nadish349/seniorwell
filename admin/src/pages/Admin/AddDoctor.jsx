  ...
  return (
   ...
   <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600 '>
    <div className='w-full lg:flex-1 flex flex-col gap-4'>
      ...
      <div className='flex-1 flex flex-col gap-1'>
        <p>Hospital or clinic name</p>
        <input onChange={(e)=>setHospital(e.target.value)}  value={hospital} className='border rounded px-3 py-2 ' type="hospital" placeholder='Hospital' required/>
